...
class appBusquedaPacienteView(Screen):
    ...
    def busqueda(self, instance):
        ...
        bn = admin()
        pacientes = bn.busquedaPacientes2()
        self.patients = []

        for paciente in pacientes:
            nombre, apellido, cedula, sexo, telefono, fecha_nacimiento = paciente
            button_text = f'Paciente: {nombre} {apellido},c.i {cedula}, sexo:{sexo}, {telefono}, fecha de nacimiento {fecha_nacimiento}'
